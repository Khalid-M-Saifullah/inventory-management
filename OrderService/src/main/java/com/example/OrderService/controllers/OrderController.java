...
public class OrderController {
    ...
    public ResponseEntity<Object> placeOrder(@RequestBody OrderRequestModel orderRequestModel) {
        ...
        Boolean paymentDone = feignClientPayment.paymentDone(orderRequestModel.getBookId(),
                orderRequestModel.getQuantity(), orderRequestModel.getUserId());
        ...
        if(availableInStock && paymentDone) {
            ...
            if (!availableInStock) {
                orderEntity.setOrderStatus("Stock out");
            } else {
                orderEntity.setOrderStatus("Payment Failed");
            }
        }
